...
IGNORED_KEYS = [
    ...
    "planet_atmosphere",
    "planet_tides",
    # star extras not covered below
    "star_evolution_starevol_star_file_path",
    "star_magnetism",
    "star_terminal_wind_speed",
    "star_tides_kaulatides_atmosphere_model",
    "star_tides_kaulatides_particle_type_stellarconvective_stellar_convective_file",
    "star_tides_kaulatides_particle_type_stellarconvective_stellar_spectrum_spin_rate",
    ...
    "star_rotation_period_days",
    # "star_stellar_raw_imaginary_k2_q0",
    # "star_stellar_raw_imaginary_k2_qm1",
    # "star_stellar_raw_imaginary_k2_qp1",
    "star_stellar_imaginary_k2_q0",
    "star_stellar_imaginary_k2_qm1",
    "star_stellar_imaginary_k2_qp1",
    "star_mass",
...
UNITS = {
    ...
    "planet_corotation_radius": {"label": "AU"},
    "star_rotation_period_days": {"label": "days"},
