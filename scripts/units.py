...
IGNORED_KEYS = [
    ...
    "perturbing_body_kind_planet_mass",
    "perturbing_body_kind_planet_radius",
    "perturbing_body_kind_planet_eccentricity",
    "perturbing_body_kind_planet_pericentre_omega",
    "perturbing_body_kind_planet_is_destroyed",
    "perturbing_body_kind_planet_longitude_ascending_node",
    "perturbing_body_kind_planet_mean_motion",
    "perturbing_body_kind_planet_inclination",
    "perturbing_body_kind_planet_spin_inclination",
    "perturbing_body_kind_planet_spin",
    "perturbing_body_kind_planet_atmosphere",
    "perturbing_body_kind_planet_roche_limit",
    "perturbing_body_kind_planet_radius_of_gyration_2",
    "perturbing_body_kind_planet_moment_of_inertia",
    "perturbing_body_kind_planet_magnetic_field",
    "perturbing_body_kind_planet_reduced_mass",
    "perturbing_body_kind_planet_density_ratio",
    "perturbing_body_kind_planet_orbit_lower_limit",
    "perturbing_body_kind_planet_magnetic_pressure",
    "perturbing_body_kind_planet_luminosity",
    "perturbing_body_magnetism",
    "perturbing_body_tides",
    "perturbing_body_wind",
...
KEY_PREFIXES = {
    ...
    "central_body_kind_": "",
    "central_body": "Star",
    "perturbing_body_kind_planet_semi_major_axis": "perturbing",
    "perturbing_body": "perturbing_body",
